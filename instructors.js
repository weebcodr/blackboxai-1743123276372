const instructors = [
    {
        ...
        specialties: ["Private", "Instrument", "Single Engine Commercial", "Multi Engine Commercial", "Initial CFI", "Instructor Instrument", "Instructor Multi Engine", "FR", "IPC", "HP"],
        approvedAircraft: ["C172", "C172RG", "C182FG", "C182RG", "C182 G1000", "PA28", "PA28R", "DA40", "BE33", "BE76"], 
    ...
    },
    {
        ...
        specialties: ["Private", "Instrument", "Single Engine Commercial", "FR", "IPC"],
        approvedAircraft: ["C172" ,"PA28", "DA40"], 
    ...
    },
    {
        ...
        specialties: ["Private", "Instrument", "Single Engine Commercial", "FR", "IPC", "HP"],
    ...
    {
        name: "Andrew Larson - Flight Instructor",
        credentials: "CFI, CFII",
        photo: "assets/images/Instructors/AndrewL.JPG",
        specialties: ["Private", "Instrument", "Single Engine Commercial", "FR", "IPC"],
